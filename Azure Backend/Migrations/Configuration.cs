...
namespace DailyFail.Backend.Migrations
{
    public class Configuration : DbMigrationsConfiguration<HeadlinerContext>
    {
        ...
        protected override void Seed(HeadlinerContext context)
        {
            var headlines = new List<Headline>();

            var headline1 = new Headline();
